...
public class LoginFrame extends JFrame {
    ...
    private void init() {
        ...
        formLogin.setPreferredSize(new Dimension(400, 550));
        ...
        formLogin.add(Box.createVerticalStrut(15));

        // Remember Me Checkbox
        jcheckbox_remember = new JCheckBox("Remember me");
        jcheckbox_remember.setFont(new Font("Arial", Font.PLAIN, 12));
        jcheckbox_remember.setBackground(Color.WHITE);
        jcheckbox_remember.setAlignmentX(Component.LEFT_ALIGNMENT);
        formLogin.add(jcheckbox_remember);
        formLogin.add(Box.createVerticalStrut(20));
    ...
    public String getPassword() {
        return new String(jtextfield_password.getPassword());
    }

    public boolean isRememberMeChecked() {
        return jcheckbox_remember.isSelected();
    }
